...
#  */
# Modified from the official implementation of labor sampler: https://github.com/dmlc/dgl/tree/master/examples/pytorch/labor
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--dataset", type=str, default="b4e",choices=["multi","b4e","ogbn-products", "cora","reddit"])
    ...
    argparser.add_argument("--logdir", type=str, default="b4e_logs")
    ...
    argparser.add_argument("--disable-checkpoint", action="store_true",default=True)
